...
export default function AboutPage() {
  return (
    <MainLayout>
      {/* Hero Section */}
      <div className="w-full mb-16 p-8 md:p-20 bg-gray-900 text-white rounded-2xl relative overflow-hidden shadow-premium-lg">
      ...
      <div className="max-w-6xl mx-auto mb-24 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative h-[500px] bg-white rounded-2xl overflow-hidden shadow-premium border-4 border-white group">
          <img
            src="/illustrations/app-mission.png"
            alt="Nutrigenics Mission"
      ...
      {/* Stats Section */}
      <div className="bg-gray-50 rounded-2xl p-12 mb-24 border border-border/50">
