    ...
    <>
      <div className="relative flex flex-col h-full items-center w-full max-w-3xl mx-auto">
        ...
        >
          ...
          {/* Input Box */}
          <div className="w-full relative bg-card rounded-3xl border border-border shadow-lg focus-within:shadow-xl focus-within:border-primary/50 transition-all overflow-hidden ring-offset-2 focus-within:ring-2 ring-primary/20 flex flex-col">
