...
export default function ProfilePage() {
  ...
  const getBmiCategory = (bmi: number) => {
    if (bmi < 18.5) return { label: 'Underweight', color: 'text-blue-500', bg: 'bg-blue-100 dark:bg-blue-900/30' };
    if (bmi < 25) return { label: 'Normal', color: 'text-emerald-500', bg: 'bg-emerald-100 dark:bg-emerald-900/30' };
    if (bmi < 30) return { label: 'Overweight', color: 'text-amber-500', bg: 'bg-amber-100 dark:bg-amber-900/30' };
    return { label: 'Obese', color: 'text-red-500', bg: 'bg-red-100 dark:bg-red-900/30' };
  };
      ...
      <Card className="relative overflow-hidden p-8 md:p-10 rounded-[2rem] border-border shadow-sm">
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            {[
              { label: 'Height', value: formData.height ? `${formData.height} cm` : 'Not set', icon: Ruler, color: 'text-blue-500', bg: 'bg-blue-100 dark:bg-blue-900/30' },
              { label: 'Weight', value: formData.weight ? `${formData.weight} kg` : 'Not set', icon: Weight, color: 'text-emerald-500', bg: 'bg-emerald-100 dark:bg-emerald-900/30' },
              ...
              { label: 'Goal', value: formData.goal || 'Not set', icon: Target, color: 'text-purple-500', bg: 'bg-purple-100 dark:bg-purple-900/30' },
            ].map((stat, i) => (
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <TabsContent value="overview" className="mt-0">
          <Card className="p-8 rounded-2xl border-border">
            ...
            <Card className="border-red-200 dark:border-red-900/50 bg-red-50/50 dark:bg-red-950/20 mt-8">
              <div className="p-6 space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-red-900 dark:text-red-100 mb-1">Danger Zone</h3>
