...
export default function SignupPage() {
    ...
    const inputClasses = "h-14 bg-white/50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus:border-logo focus:ring-4 focus:ring-logo/10 transition-all rounded-xl text-sm font-medium";
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col items-center justify-between overflow-hidden">
            ...
            <div className="flex-1 w-full h-full flex items-center justify-center sm:p-6 p-4">
                <AuthCard delay={0.2}>
                        ...
                        >
                            {step === 1 && (
                                <div className="space-y-6">
                                    ...
                                    <Button onClick={handleContinue} className="w-full h-14 bg-gray-900 text-white hover:bg-gray-800 text-base font-medium rounded-xl group shadow-[0_10px_30px_-10px_rgba(0,0,0,0.2)] hover:shadow-[0_15px_35px_-10px_rgba(0,0,0,0.25)] transition-all">
                            ...
                            {step === 2 && (
                                <div className="space-y-5">
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 bg-black/[0.02] p-4 rounded-xl border border-black/5">
                                            {[
                                    ...
                                    <div className="flex gap-4">
                                        <Button variant="outline" onClick={() => setStep(1)} className="h-14 px-6 bg-black/[0.03] border-black/5 text-gray-700 hover:bg-black/[0.06] rounded-xl transition-all">
                                            <ChevronLeft className="w-5 h-5" />
                                        </Button>
                                        <Button onClick={handleContinue} className="flex-1 h-14 bg-gray-900 text-white hover:bg-gray-800 font-bold rounded-xl shadow-[0_10px_30px_-10px_rgba(0,0,0,0.2)] transition-all" disabled={!isPasswordValid(passwordValidation) || password !== confirmPassword}>
                            ...
                            {step === 3 && (
                                <div className="space-y-4">
                                    <div className="grid gap-3">
                                        {roleOptions.map((opt) => (
                                            <button
                                                ...
                                                className={`relative w-full p-4 rounded-xl border-2 transition-all duration-300 text-left overflow-hidden group ${selectedRole === opt.role
                                                    ? 'border-logo bg-logo/5 shadow-[0_5px_15px_rgba(100,245,10,0.05)]'
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <Button variant="outline" onClick={() => setStep(2)} className="h-14 px-6 bg-black/[0.03] border-black/5 text-gray-700 rounded-xl" disabled={isLoading}>
                                            <ChevronLeft className="w-5 h-5" />
                                        </Button>
                                        <Button onClick={handleSubmit} className="flex-1 h-14 bg-gray-900 text-white hover:bg-gray-800 font-bold rounded-xl shadow-[0_10px_30px_-10px_rgba(0,0,0,0.2)] transition-all group" disabled={!selectedRole || isLoading}>
                                            {isLoading ? (
