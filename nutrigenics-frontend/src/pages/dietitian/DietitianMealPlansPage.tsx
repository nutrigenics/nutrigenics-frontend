                                ...
                                <Card key={meal.id} className="p-4 rounded-[1.5rem] border-gray-100 shadow-sm hover:shadow-md transition-all relative group bg-white overflow-hidden">
                                    {meal.recipe?.recipe_image && (
                                        <div className="w-full h-32 rounded-xl overflow-hidden mb-3">
                                            <img
                                                src={meal.recipe.recipe_image.startsWith('http') ? meal.recipe.recipe_image : `${API_BASE_URL}/media/${meal.recipe.recipe_image}`}
                                ...
                                {filteredRecipes.length === 0 ? (
                                    ...
                                    filteredRecipes.map(recipe => (
                                        ...
                                        >
                                            {recipe.recipe_image && (
                                                <img
                                                    src={recipe.recipe_image.startsWith('http') ? recipe.recipe_image : `${API_BASE_URL}/media/${recipe.recipe_image}`}
