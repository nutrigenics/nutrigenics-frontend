...
import { TrendingUp, Activity, PieChart, LineChart, ArrowRight } from 'lucide-react';
    ...
    <MainLayout>
      ...
      <div className="w-full mb-8 p-8 md:p-12 bg-white rounded-[2.5rem] relative overflow-hidden shadow-[0_20px_50px_-12px_rgba(0,0,0,0.05)] border border-gray-100 text-center">
        <div className="relative z-10 flex flex-col items-center max-w-2xl mx-auto">
          ...
          >
            Patient <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-600">Insights</span>
          </motion.h1>
          ...
          >
            Detailed progress tracking and adherence reports for your patients.
          </motion.p>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {[
            { icon: Activity, title: "Health Vitals", desc: "Monitor weight, BMI, and other key health metrics over time." },
            { icon: PieChart, title: "Meal Adherence", desc: "Track how closely patients are following their meal plans." },
            { icon: LineChart, title: "Trend Analysis", desc: "Identify long-term trends and adjust plans accordingly." },
            { icon: TrendingUp, title: "Goal Tracking", desc: "Visualize progress towards specific health goals." }
          ].map((feature, i) => (
            <motion.div
              key={i}
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-gray-400 mb-6">Advanced analytics tools for dietitians are in development.</p>
